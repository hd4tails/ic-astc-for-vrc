// ASTC 4×4圧縮で、各ブロックのエンドポイント候補を複数のバッチに分けて生成するシェーダー
// 構成: 6つのPassで構成し、Astc4x4CompressCommon.cgincを読み込んで共通の頂点処理・補助関数を利用する
// 各Passが異なる候補バッチ用のフラグメント関数を担当する
Shader "HDAssets/IC/ASTC/ASTC4x4CompressBlit"
{
    Properties
    {
