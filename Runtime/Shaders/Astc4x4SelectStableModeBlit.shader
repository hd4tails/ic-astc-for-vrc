// ASTCの再調整結果と保持済み候補から、安定して再現できるブロックモードを選ぶシェーダー
// 構成: 1つのPassで構成し、Astc4x4CompressCommon.cgincを読み込んで共通の頂点処理・補助関数を利用する
Shader "HDAssets/IC/ASTC/ASTC4x4SelectStableModeBlit"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "SelectStableMode"
            CGPROGRAM
            #pragma vertex vert
            #pragma fragment fragSelectStableMode
            ENDCG
        }
    }
    Fallback Off
