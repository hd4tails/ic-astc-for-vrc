// ASTCのdual-plane（2プレーン）候補を入力ブロックに対して評価し、後段へ渡す候補を選ぶシェーダー
// 構成: 1つのPassで構成し、Astc4x4CompressCommon.cgincを読み込んで共通の頂点処理・補助関数を利用する
Shader "HDAssets/IC/ASTC/ASTC4x4SelectDualPlaneBlit"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "SelectDualPlane"
            CGPROGRAM
            #pragma vertex vert
            #pragma fragment fragSelectDualPlane
            ENDCG
        }
    }
    Fallback Off
