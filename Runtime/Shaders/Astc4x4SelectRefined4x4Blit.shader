// ASTC 4×4ブロック向けの再調整結果を比較し、次の選択段階へ渡す候補を決めるシェーダー
// 構成: 1つのPassで構成し、Astc4x4CompressCommon.cgincを読み込んで共通の頂点処理・補助関数を利用する
Shader "HDAssets/IC/ASTC/ASTC4x4SelectRefined4x4Blit"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "SelectRefined4x4"
            CGPROGRAM
            #pragma vertex vert
            #pragma fragment fragSelectRefined4x4
            ENDCG
        }
    }
    Fallback Off
